...
describe('iso', function() {
    ...
    describe('iso.list', function() {
        ...
        it('each element should have property "alpha2" as String', function() {
            for (const val of iso.list) {
                assert.equal(has(val, 'alpha2'), true);
                assert.equal(typeof val.alpha2, 'string');
            }
        });
    ...
    describe('iso.validate', function() {
        ...
        describe('should return TRUE when', function() {
            ...
            it('call with code "alpha2"', function() {
                test('AF');
            });
    ...
    describe('iso.get', function() {
        ...
        describe('should return object when', function() {
            const test = code => {
                ...
                assert.deepEqual(keys.length, 4);
                assert.deepEqual(keys.includes('country'), true);
                assert.deepEqual(keys.includes('alpha2'), true);
    ...
    describe('iso.getCodeList', function() {
        ...
        describe('should return objects list when', function() {
            ...
            it('call with code "alpha2" as array', function() {
                test(['alpha2']);
            });
            ...
            it('call with codes "alpha2", "alpha3", "numeric" as array', function() {
                test(['alpha2', 'alpha3', 'numeric']);
            });

            it('call with codes "alpha2", "alpha3", "numeric" as multiple arguments', function() {
                test('alpha2', 'alpha3', 'numeric');
            });

            it('call with codes "alpha2", "alpha3", "numeric" as multiple double arguments', function() {
                test('alpha2', 'alpha3', 'numeric', 'alpha2', 'alpha3', 'numeric');
            });

            it('call with codes "alpha2", "alpha3", "numeric" as double array', function() {
                test(['alpha2', 'alpha3', 'numeric'], ['alpha2', 'alpha3', 'numeric']);
            });
        });
    });
